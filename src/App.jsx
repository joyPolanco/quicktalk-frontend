...
function App() {
  ...
  return (
    <div className="min-h-screen  w-full bg-slate-900 relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute top-0 -left-4 size-96 bg-cyan-800 opacity-20 blur-[100px]" />
      <div className="absolute bottom-0 -right-4 size-96 bg-cyan-800 opacity-20 blur-[100px]" />
    <Toaster/>
